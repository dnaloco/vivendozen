...
function r2gozen_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'r2gozen' ),
	) );
...
function r2gozen_scripts() {
	...
	wp_enqueue_script( 'r2gozen-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'r2gozen-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
